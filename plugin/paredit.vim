...
function! PareditInitBuffer()
    ...
    if g:paredit_mode
        ...
        if g:paredit_shortmaps
            ...
            call RepeatableNNoRemap('N', ':<C-U>call PareditJoin()') 
            call RepeatableNNoRemap('W', ':<C-U>call PareditWrap("(",")")') 
            vnoremap <buffer> <silent> =  :<C-U>call PareditWrapSelection('(',')')<CR>
            ...
            " call RepeatableNNoRemap(g:paredit_leader . 'N', ':<C-U>call PareditJoin()') 
